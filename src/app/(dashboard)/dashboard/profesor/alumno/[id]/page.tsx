                                ...
                                <div style={{ paddingBottom: '0.5rem' }}>
                                  ...
                                  {ex.sets?.map((set: any, sIdx: number) => (
                                    <div key={set.id} className="routine-grid-row" style={{ backgroundColor: 'var(--surface)', borderRadius: '0.5rem', border: '1px solid var(--border)', transition: 'background-color 0.2s', marginBottom: '0.5rem' }}>
                                      ...
                                      <div>
                                        <input type="text" value={set.reps || ''} onChange={e => handleSetChange(ex.id, set.id, 'reps', e.target.value)} style={{ width: '100%', maxWidth: '80px', padding: '0.4rem', backgroundColor: 'rgba(255, 255, 255, 0.05)', border: '1px solid var(--border)', borderRadius: '0.25rem', color: 'var(--foreground)', textAlign: 'center', fontSize: '0.875rem', fontWeight: 'bold' }} />
                                      </div>
                                      <div>
